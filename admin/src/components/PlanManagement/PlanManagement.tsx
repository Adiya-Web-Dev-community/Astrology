    ...
    <div className="container mx-auto p-4">
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent>
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <Input {...register("name", { required: true })} placeholder="Plan Name" className="mb-4" />
            <Input {...register("price", { required: true })} placeholder="Price" type="number" className="mb-4" />
            <Input {...register("maxMessages")} placeholder="Max Messages" type="number" className="mb-4" />
            <Input {...register("maxMessageSize")} placeholder="Max Message Size" type="number" className="mb-4" />
            <Input {...register("duration")} placeholder="Duration (days)" type="number" className="mb-4" />
            <Input {...register("questions")} placeholder="Questions Allowed" type="number" className="mb-4" />
            <div className="mb-4">
              <label>
                <input {...register("includesRemedies")} type="checkbox" /> Includes Remedies
              </label>
            </div>
            <DialogFooter>
              <Button type="submit">{dialogMode === "create" ? "Create" : "Update"}</Button>
